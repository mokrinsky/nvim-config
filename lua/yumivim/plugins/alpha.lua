...
function M.config()
  ...
  local default_header = {
    ...
    val = {
      [[                                            __                    ]],
      [[         ___     ___    ____  ___   __  __ /\_\    ___ ___        ]],
      [[        / _ `\  / __`\ / ___\/ __`\/\ \/\ \\/\ \  / __` __`\      ]],
      [[       /\ \/\ \/\  __//\ \__/\ \_\ \ \ \_/ |\ \ \/\ \/\ \/\ \     ]],
      [[       \ \_\ \_\ \____\ \___\ \____/\ \___/  \ \_\ \_\ \_\ \_\    ]],
      [[        \/_/\/_/\/____/\/___/\/___/  \/__/    \/_/\/_/\/_/\/_/    ]],
    },
    opts = {
      hl = 'Type',
      shrink_margin = false,
  ...
  local section = {
    ...
    bottom_buttons = {
      type = 'group',
      val = {
        { type = 'text', val = 'Commands', opts = { hl = 'SpecialComment', position = 'center' } },
        { type = 'padding', val = 1 },
        button('p', '  Projects', '<cmd>Telescope repo list<CR>'),
        button('o', '  More MRU', '<cmd>Telescope oldfiles<CR>'),
